...
public class AdminTaBortAlien extends javax.swing.JFrame {
    ...
    private void adminraderabtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminraderabtnActionPerformed
        if (Validering.textFaltHarVarde(admindeletealientxt) && Validering.isHeltal(admindeletealientxt)) {
            try {
                ...
                pst.setString(1, admindeletealientxt.getText());
                pst.executeUpdate();
                String sql3 = "DELETE FROM squid WHERE Alien_ID=?";
                con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mibdb", "mibdba", "mibkey");
                pst = con.prepareStatement(sql3);
                pst.setString(1, admindeletealientxt.getText());
                pst.executeUpdate();
                String sql4 = "DELETE FROM worm WHERE Alien_ID=?";
                con = DriverManager.getConnection("jdbc:mysql://localhost:3306/mibdb", "mibdba", "mibkey");
                ...
                JOptionPane.showMessageDialog(null, "Funkade ej!");
            }
        }
